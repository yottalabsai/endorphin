...
type YottaLabsStream struct {
	...
	ModelType string `protobuf:"bytes,2,opt,name=model_type,json=modelType,proto3" json:"model_type,omitempty"` // 模型类型
	Timestamp int64  `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                 // 时间戳
	MessageId string `protobuf:"bytes,4,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` // 请求ID， 用于幂等，谁发起消息，谁负责生成 message_id；
	// Types that are assignable to Payload:
	//
	//	*YottaLabsStream_Ping
	//	*YottaLabsStream_Pong
	//	*YottaLabsStream_ErrorResult
...
func (x *YottaLabsStream) GetModelType() string {
	if x != nil {
		return x.ModelType
	}
	return ""
...
func (x *YottaLabsStream) GetErrorResult() *ErrorResult {
	if x, ok := x.GetPayload().(*YottaLabsStream_ErrorResult); ok {
...
type YottaLabsStream_Ping struct {
	Ping *PingMessage `protobuf:"bytes,5,opt,name=ping,proto3,oneof"`
}

type YottaLabsStream_Pong struct {
	Pong *PongResult `protobuf:"bytes,6,opt,name=pong,proto3,oneof"`
}

type YottaLabsStream_ErrorResult struct {
	ErrorResult *ErrorResult `protobuf:"bytes,7,opt,name=error_result,json=errorResult,proto3,oneof"`
}

type YottaLabsStream_RunModelMessage struct {
	RunModelMessage *RunModelMessage `protobuf:"bytes,8,opt,name=run_model_message,json=runModelMessage,proto3,oneof"`
}

type YottaLabsStream_RunModelResult struct {
	RunModelResult *RunModelResult `protobuf:"bytes,9,opt,name=run_model_result,json=runModelResult,proto3,oneof"`
}

type YottaLabsStream_InferenceMessage struct {
	InferenceMessage *InferenceMessage `protobuf:"bytes,10,opt,name=inference_message,json=inferenceMessage,proto3,oneof"`
}

type YottaLabsStream_InferenceResult struct {
	InferenceResult *InferenceResult `protobuf:"bytes,11,opt,name=inference_result,json=inferenceResult,proto3,oneof"`
}

type YottaLabsStream_TextToImageMessage struct {
	TextToImageMessage *TextToImageMessage `protobuf:"bytes,12,opt,name=text_to_image_message,json=textToImageMessage,proto3,oneof"`
}

type YottaLabsStream_TextToImageResult struct {
	TextToImageResult *TextToImageResult `protobuf:"bytes,13,opt,name=text_to_image_result,json=textToImageResult,proto3,oneof"`
}
...
func (*YottaLabsStream_ErrorResult) isYottaLabsStream_Payload() {}
...
type TextToImageMessage struct {
	...
	NumInferenceSteps int32   `protobuf:"varint,2,opt,name=numInferenceSteps,proto3" json:"numInferenceSteps,omitempty"`
	...
	PagScale          float64 `protobuf:"fixed64,8,opt,name=pagScale,proto3" json:"pagScale,omitempty"`
}
...
func (x *TextToImageMessage) GetPrompt() string {
	if x != nil {
		return x.Prompt
	}
	return ""
...
func (x *TextToImageMessage) GetNumInferenceSteps() int32 {
	if x != nil {
...
func (x *TextToImageMessage) GetHeight() int32 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *TextToImageMessage) GetWidth() int32 {
	if x != nil {
		return x.Width
	}
	return 0
...
func (x *TextToImageMessage) GetPagScale() float64 {
	if x != nil {
		return x.PagScale
	}
	return 0
...
func (x *TextToImageResult) Reset() {
	*x = TextToImageResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_synapse_stream_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TextToImageResult) Descriptor() ([]byte, []int) {
	return file_services_synapse_stream_proto_rawDescGZIP(), []int{11}
}

func (x *TextToImageResult) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *TextToImageResult) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *TextToImageResult) GetImages() []*ImageResult {
	if x != nil {
		return x.Images
	}
	return nil
...
type ImageResult struct {
	...
	IsSafePrompt bool    `protobuf:"varint,3,opt,name=is_safe_prompt,json=isSafePrompt,proto3" json:"is_safe_prompt,omitempty"`
}

func (x *ImageResult) Reset() {
	*x = ImageResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_synapse_stream_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImageResult) Descriptor() ([]byte, []int) {
	return file_services_synapse_stream_proto_rawDescGZIP(), []int{12}
}
...
func (x *ImageResult) GetLatency() float64 {
	if x != nil {
		return x.Latency
	}
	return 0
...
func (x *ImageResult) GetIsSafePrompt() bool {
	if x != nil {
		return x.IsSafePrompt
	}
	return false
}
...
var file_services_synapse_stream_proto_rawDesc = []byte{
	...
	0x73, 0x79, 0x6e, 0x61, 0x70, 0x73, 0x65, 0x22, 0xed, 0x06, 0x0a, 0x0f, 0x59, 0x6f, 0x74, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x23, 0x0a, 0x0d, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x55,
	0x73, 0x61, 0x67, 0x65, 0x22, 0x2b, 0x0a, 0x0f, 0x49, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	...
	,
	...
	,
	...
	,
}
...
var file_services_synapse_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_services_synapse_stream_proto_goTypes = []interface{}{
	(*YottaLabsStream)(nil),    // 0: yotta.services.synapse.YottaLabsStream
	(*PingMessage)(nil),        // 1: yotta.services.synapse.PingMessage
	(*PongResult)(nil),         // 2: yotta.services.synapse.PongResult
	(*ErrorResult)(nil),        // 3: yotta.services.synapse.ErrorResult
	(*RunModelMessage)(nil),    // 4: yotta.services.synapse.RunModelMessage
	(*RunModelResult)(nil),     // 5: yotta.services.synapse.RunModelResult
	(*InferenceMessage)(nil),   // 6: yotta.services.synapse.InferenceMessage
	(*Message)(nil),            // 7: yotta.services.synapse.Message
	(*StreamOptions)(nil),      // 8: yotta.services.synapse.StreamOptions
	(*InferenceResult)(nil),    // 9: yotta.services.synapse.InferenceResult
	(*TextToImageMessage)(nil), // 10: yotta.services.synapse.TextToImageMessage
	(*TextToImageResult)(nil),  // 11: yotta.services.synapse.TextToImageResult
	(*ImageResult)(nil),        // 12: yotta.services.synapse.ImageResult
}
var file_services_synapse_stream_proto_depIdxs = []int32{
	1,  // 0: yotta.services.synapse.YottaLabsStream.ping:type_name -> yotta.services.synapse.PingMessage
	2,  // 1: yotta.services.synapse.YottaLabsStream.pong:type_name -> yotta.services.synapse.PongResult
	3,  // 2: yotta.services.synapse.YottaLabsStream.error_result:type_name -> yotta.services.synapse.ErrorResult
	4,  // 3: yotta.services.synapse.YottaLabsStream.run_model_message:type_name -> yotta.services.synapse.RunModelMessage
	5,  // 4: yotta.services.synapse.YottaLabsStream.run_model_result:type_name -> yotta.services.synapse.RunModelResult
	6,  // 5: yotta.services.synapse.YottaLabsStream.inference_message:type_name -> yotta.services.synapse.InferenceMessage
	9,  // 6: yotta.services.synapse.YottaLabsStream.inference_result:type_name -> yotta.services.synapse.InferenceResult
	10, // 7: yotta.services.synapse.YottaLabsStream.text_to_image_message:type_name -> yotta.services.synapse.TextToImageMessage
	11, // 8: yotta.services.synapse.YottaLabsStream.text_to_image_result:type_name -> yotta.services.synapse.TextToImageResult
	7,  // 9: yotta.services.synapse.InferenceMessage.messages:type_name -> yotta.services.synapse.Message
	8,  // 10: yotta.services.synapse.InferenceMessage.stream_options:type_name -> yotta.services.synapse.StreamOptions
	12, // 11: yotta.services.synapse.TextToImageResult.images:type_name -> yotta.services.synapse.ImageResult
...
func file_services_synapse_stream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_synapse_stream_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_synapse_stream_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_synapse_stream_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*YottaLabsStream_ErrorResult)(nil),
